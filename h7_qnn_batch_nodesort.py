...
TAREA 2 - INTERPRETACIÓN Y PERSPECTIVA:
...
A partir de estos valores, genera un mensaje (máximo 5 párrafos)
Respondiendo la pregunta directamente. Si la covarianza promedio es alta,
